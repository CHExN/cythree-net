...
/**
 * 在这里不论添加什么字段，都得去UnionStoreroomOutAdd.vue里，在转换JSON的时候把新加的字段给去除
 * @author CHExN
 */
@Data
@TableName("cy_union_storeroom")
public class UnionStoreroom implements Serializable {

    private static final long serialVersionUID = 4236557965958889603L;
